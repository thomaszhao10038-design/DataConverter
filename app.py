...
def build_output_excel(sheets_dict):
    ...
    for sheet_name, df in sheets_dict.items():
        ...
        for date in dates:
            ...
            # Changed the date key to include the year for the "Total" sheet consistency
    ...
    chart_total.x_axis.title = "Date (YYYY-MM-DD)"
    ...
    # This addresses the request to display the day date including year
